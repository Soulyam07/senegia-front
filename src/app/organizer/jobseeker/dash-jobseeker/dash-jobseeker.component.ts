...
@Component({
  ...
  templateUrl: './dash-jobseeker.component.html',
  styleUrl: './dash-jobseeker.component.scss'
})
export class DashJobseekerComponent implements OnInit {
